...
export class StatisticsService {
  ...
  async getStructuresStats() {
    try {
      ...
      // Récupérer les structures principales (sans parent) avec le nombre de stagiaires
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des statistiques des structures');
    }
  }
  ...
  async getDemandesEvolution() {
    try {
      ...
      // Récupérer les 6 derniers mois de demandes
      ...
      // Initialiser le résultat avec tous les mois à 0
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération de l\'évolution des demandes');
    }
  }
  ...
  async getGeneralStats() {
    try {
      ...
      return {
        ...
        tauxSatisfaction: 4.5, // À implémenter avec un système de notation
        trend,
        trendEnCours: 0, // À implémenter
        trendCompletion: 0, // À implémenter
        trendSatisfaction: 0 // À implémenter
      };
    } catch (error) {
      console.error('Erreur détaillée dans getGeneralStats:', error);
      throw new InternalServerErrorException('Erreur lors de la récupération des statistiques générales');
    }
  }
  ...
  async getTypeStats() {
    try {
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des statistiques par type');
    }
  }
  ...
  async getEducationStats() {
    try {
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des statistiques par niveau');
    }
  }

  async getTuteursStats(structureId: number) {
    try {
      // Récupérer les tuteurs de la structure avec le nombre de stagiaires affectés à chacun
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des stats tuteurs');
    }
  }

  async getGeneralStatsByStructure(structureId: number) {
    try {
      const total = await this.prisma.stageRequest.count({
        where: {
          stagiaire: {
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des statistiques générales de la structure');
    }
  }

  async getTypeStatsByStructure(structureId: number) {
    try {
      const types = await this.prisma.stageRequest.groupBy({
        by: ['type'],
        where: {
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des statistiques par type de la structure');
    }
  }

  async getEducationStatsByStructure(structureId: number) {
    try {
      const niveaux = await this.prisma.stageRequest.groupBy({
        by: ['anneeEtude'],
        where: {
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des statistiques par niveau de la structure');
    }
  }

  async getDemandesEvolutionByStructure(structureId: number) {
    try {
      const sixMonthsAgo = new Date();
      sixMonthsAgo.setMonth(sixMonthsAgo.getMonth() - 6);
      const months = Array.from({ length: 6 }, (_, i) => {
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération de l\'évolution des demandes de la structure');
    }
  }

  async getTuteurStats(tuteurId: string) {
    try {
      // Récupérer les stagiaires affectés au tuteur
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des stats tuteur');
    }
  }

  async getTuteurActivities(tuteurId: string) {
    try {
      // Récupérer les activités récentes du tuteur
      const activities: any[] = [];

      // Nouvelles affectations de stagiaires
      ...
      throw new InternalServerErrorException('Erreur lors de la récupération des activités tuteur');
    }
  }
} 